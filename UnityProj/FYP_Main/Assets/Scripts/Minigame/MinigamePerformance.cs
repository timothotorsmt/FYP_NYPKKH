...
{
    private static float _totalNumPoints = 0; // The total number of points the player has at the moment 
    private static float _totalPossiblePoints = 0; // The total number of possible points that can be earned in the minigame
