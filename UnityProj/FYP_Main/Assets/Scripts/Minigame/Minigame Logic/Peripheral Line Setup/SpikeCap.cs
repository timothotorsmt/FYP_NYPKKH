...
public class SpikeCap : MonoBehaviour
{
    ...
    {
        if (_spikeCap.value >= _capClosePercentage && PeriLineControl.Instance.GetCurrentTask() == PeriLineTasks.REMOVE_SPIKE_IV_TUBE && !_isRunning)
        {
            ...
            seq.AppendCallback(() => PeriLineControl.Instance.MarkCurrentTaskAsDone());
